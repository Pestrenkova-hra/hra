// https://pestrenkova-hra.github.io/hra/
// Menu stavů hry
const GameState = {
    MENU: 'menu',
    INFO: 'info',
...
function showMenu() {
    ...
    this.add.image(config.width / 2, config.height / 3 + 30, "nadpis").setOrigin(0.5); // Přidá nadpis PH
    ...
    buttonStart.on('pointerdown', () => {
        gameState = GameState.PLAYING; // Změníme fázi hry
